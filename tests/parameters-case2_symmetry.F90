...
!***************************************************************************
   ...
   integer,     parameter :: i_Nic         = 16   !< Number of inner core radial points (for insulating set `=1`)
...
!  hyperviscosity.
   ...
   !> Rayleigh Number
   double precision, parameter :: d_Ra          = 7.15d04
